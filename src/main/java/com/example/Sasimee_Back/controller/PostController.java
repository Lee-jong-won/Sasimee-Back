...
public class PostController {
    ...
    @PostMapping("/create")
    @ApiResponses({
            @ApiResponse(responseCode = "400", description = "게시글 등록 성공"),
            @ApiResponse(responseCode = "200", description = "게시글 등록 실패")
    })
    ...
    @GetMapping("/{postId}")
    @ApiResponses({
            @ApiResponse(responseCode = "400", description = "게시글 ID 조회 성공"),
            @ApiResponse(responseCode = "200", description = "게시글 ID 조회 실패")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "400", description = "태그를 포함한 게시글들 조회 성공"),
            @ApiResponse(responseCode = "200", description = "태그를 포함한 게시글들 조회 실패")
    })
    ...
    @GetMapping
    @ApiResponses({
            @ApiResponse(responseCode = "400", description = "페이징을 통한 게시글들 조회 성공"),
            @ApiResponse(responseCode = "200", description = "페이징을 통한 게시글들 조회 실패")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "400", description = "ID 기반 게시글 삭제 성공"),
            @ApiResponse(responseCode = "200", description = "ID 기반 게시글 삭제 실패")
    })
